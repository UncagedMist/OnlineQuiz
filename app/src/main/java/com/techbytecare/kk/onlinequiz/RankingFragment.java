...
import com.techbytecare.kk.onlinequiz.Interface.ItemClickListener;
import com.techbytecare.kk.onlinequiz.Interface.RankingCallBack;
import com.techbytecare.kk.onlinequiz.Model.QuestionScore;
import com.techbytecare.kk.onlinequiz.Model.Ranking;
import com.techbytecare.kk.onlinequiz.ViewHolder.RankingViewHolder;
...
public class RankingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //bcz orderbyChild will post the result in ascending order
        //so we will reverrse our recycler data
        ...
        updateScore(Common.currentUser.getUserName(), new RankingCallBack<Ranking>() {
            ...
            public void callBack(Ranking ranking) {
              ...
              //  showRanking();  //after upload sort it
            }
        });
        //set adapter
